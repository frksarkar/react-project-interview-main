						...
						<ul className="overflow-hidden transition-all duration-500 ease-in-out font_sans">
							...
							>
								...
								>
									...
									{cart ? (
										<span className="bg-bg_selected text-white px-2 text-center rounded-full text-text_md">
											{cart?.quantity}
										</span>
									) : null}
								</Link>
